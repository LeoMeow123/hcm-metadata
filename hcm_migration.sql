...
insert into hcm_cohorts (id, meta, updated_by) values
 ('coh_app',     '{"batch":"APP-study","start":"2024-09-24","end":"~2026-03-01","genotypes":"Cam1 WT | Cam2 APP | Cam3 APP | Cam4 WT  (WT={1,4}, APP={2,3})","cages":{"1":"WT","2":"APP","3":"APP","4":"WT"},"mice_per_cage":"3","in_manifest":"64,269 chunks","note":"Born ~Apr 2024. Each cage later dropped 3->2: Cam1 ~2025-10-18, Cam2 ~2025-12-27, Cam3 ~2025-10-18, Cam4 ~2024-10-15. Manifest (home_cage_manifest.csv) genotype for cam_02/cam_04 is INVERTED - do not trust it. APP sexes: dashboard vs EVENTS.md disagree."}', 'Leo'),
 ('coh_gap',     '{"batch":"(empty gap)","start":"~2026-03-01","end":"2026-05-06","genotypes":"none (empty)","cages":{},"mice_per_cage":"0","in_manifest":"7,056 chunks (skip)","note":"Recording continued but no mice present."}', 'Leo'),
 ('coh_pd',      '{"batch":"PD-arrive","start":"2026-05-07","end":"2026-05-13","genotypes":"Cam3 PD | Cam4 WT-sentinel  (Cam1,2 empty)","cages":{"3":"PD","4":"WT-s"},"mice_per_cage":"2 cages (Cam3,4)","in_manifest":"608 chunks","note":"1 wk settling. PD placed in Cam3,4 on 05-07; Cam1,2 still empty. Cam4 later confirmed WT sentinel."}', 'Leo'),
 ('coh_tauwtpd', '{"batch":"Tau/WT/PD full-cohort","start":"2026-05-14","end":"2026-07-30","genotypes":"Cam1 Tau | Cam2 WT | Cam3 PD | Cam4 WT-sentinel","cages":{"1":"Tau","2":"WT","3":"PD","4":"WT-s"},"mice_per_cage":"2","in_manifest":"12,499 chunks (snapshot ends 07-21)","note":"~2 mo. Cam3,4 carried over from PD-arrive; Cam1,2 (Tau,WT) added 05-14 16:00. Cam1 Tau fatality 07-02 13:00 (->N=1); water flood Cam1 07-02->07-05 (exclude). Cam4 relabeled WT sentinel 06-22. Transfer OUT 07-30 15:00 to CRAF 2909 r5 (cages K-N): 1 Tau, 2 WT, 6 PD."}', 'Leo'),
 ('coh_wt',      '{"batch":"WT-cohort","start":"2026-07-30","end":"present","genotypes":"all WT - Cam1,2 female | Cam3,4 male","cages":{"1":"WT","2":"WT","3":"WT","4":"WT"},"mice_per_cage":"F x3 (Cam1,2) / M x2 (Cam3,4)","in_manifest":"not in manifest snapshot (ends 07-21)","note":"Current. All WT, DOB ~2026-03-30. Transfer IN 2026-07-30 15:00 PT (3PM): 4mo-WT, 6 female (3+3, Cam1&2) + 4 male (2+2, Cam3&4)."}', 'Leo')
